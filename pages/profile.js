...
const Profile = () => {
    ...
    return (
        <Layout>
            ...
            <div className="max-w-[90%] m-4 mx-auto mt-8 md:mt-20 shadow-sm shadow-black  bg-white rounded-lg border border-gray-200 shadow-md ">
                ...
                <div className="flex flex-col items-center pb-10 ">
                    ...
                    <h5 className="mb-1  font-medium text-gray-900 text-sm">{userDetails.name}</h5>
                    <h5 className="mb-1 font-medium text-gray-600 text-sm">{userDetails.walletAddress}</h5>
