      ...
      <header className="text-gray-700 body-font border-b border-gray-200">
        <div className="container mx-auto  flex-wrap p-2 flex md:flex-row items-center">
          <a className="flex  title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="/" target="_blank">
            <img src="/assets/svg.svg" className="w-10  sm:h-9 md:mt-0 mt-6 mr-2 md:mr-3" />
          ...
          focus:outline-none hover:bg-gray-300 rounded text-base mt-4 md:mt-0">
            {loading ?
              <svg role="status" className="inline mr-2 w-5 h-5 text-white animate-spin dark:text-white fill-gray-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="text-gray-700 body-font border-t border-gray-200">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            ...
            <div className="p-4 md:w-1/3">
              <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                ...
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    The xpace Token is Created on top of <span className="font-bold">Harmony ONE</span> to aid Decentralised, easy ,faster  and secure transactions on the WebApp.
                    the token is created on top of <span className="font-bold">Harmony ONE</span>, Blockchain that can process many more transactions per second and charge lower transaction fees.
                  </p>
          ...
          focus:outline-none hover:bg-indigo-600 rounded text-lg">
            ...
            {loading ?
              <svg role="status" className="inline mr-2 w-10 h-10 text-white animate-spin dark:text-white fill-gray-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="currentColor" />
                <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentFill" />
              </svg>
              :
        ...
        <div className="relative p-4 w-full max-w-md h-full md:h-auto ">
          ...
          <div className="relative bg-white border-2 border-indigo-900 rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 pt-0 text-center">
              ...
              <h3 className="mb-5 text-lg text-gray-500 font-bold dark:text-gray-700">MetaMask not detected</h3>
              <h3 className="mb-5 text-xl font-normal text-gray-500 dark:text-gray-400">You must have a harmony wallet to continue</h3>
