        ...
        <Layout>
            ...
            <div className="max-w-sm mx-auto mt-8 md:mt-20 shadow-sm shadow-black  bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="flex flex-col items-center pb-10">
                    ...
                    <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">{tuser.name}</h5>
                    <h5 className="mb-1 font-medium text-gray-600 dark:text-white">{tuser.walletAddress}</h5>
                    <span className="text-sm text-gray-500 dark:text-gray-400">{tuser.bio}</span>
